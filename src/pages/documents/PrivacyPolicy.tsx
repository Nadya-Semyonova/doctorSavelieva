  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <p>— заключение и исполнение условий договора.</p>
        ...
        <p>3.5. Оператор обрабатывает следующие персональные данные клиентов:</p>
        ...
        <p>
          — производит ознакомление третьих лиц с положениями законодательства о персональных
        ...
        <p>
          5.2. Для реализации своих прав и законных интересов субъекты персональных данных имеют
