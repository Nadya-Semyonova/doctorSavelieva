...
const benefits = [
  "Вы получите дальнейшую тактику лечения и маршрутизацию исходя из жалоб и/или диагноза",
  "Узнаете второе мнение по поводу уже имеющегося диагноза и/или лечения",
  "Сможете запросить расшифровку и/или комментарии по результатам анализов и/или исследований",
